...
import com.aaa.one.properties.RedisClusterProperties;
 ...
 * @Author hhy
 * @Version 0.1.0
 * @Date Create in 2020/5/13 22:00
 * @Description
 */
@Configuration
public class RedisClusterConfig {
    ...
    public JedisCluster getJedisCluster() {
        // 1.获取redis的IP地址以及端口号信息(192.168.237.130:6380,192.168.237.130:6381...6385)
